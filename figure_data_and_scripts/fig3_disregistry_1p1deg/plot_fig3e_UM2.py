"""
Figure 3e: Voronoi-centered disregistry vector distribution for UM2 (10 Ang cutoff).

Reads the UM2-relaxed 1.1-deg twisted MoS2/WSe2 structure and the
...
def create_displacement_plot(displacements_list, A1, confined_displacements_energy, energies,
                             output_file='fig3e_disregistry_UM2.pdf',
...
def main():
    ...
    structure = read('MoS2-WSe2_1p1deg_UM2_relaxed.xyz', index='-1', format='extxyz')
    ...
    cache_file = 'MoS2-WSe2_1p1deg_displacements_UM2.npy'
